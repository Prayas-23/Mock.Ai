...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validate email format - first check if email is provided
    if (!formData.email) {
  ...
  const words = ["Sign Up", "Register", "Join"];
            ...
            <div className="relative z-10 bg-black/70 backdrop-blur-lg rounded-2xl border border-white/10 p-8 shadow-2xl">
              ...
              {signupSuccess ? (
                <div className="text-center py-8">
                  ...
                  <h3 className="mt-4 text-2xl font-medium text-white">Account Created!</h3>
                    ...
                    <div className="mt-6">
                      ...
                      >
                        <svg className="h-5 w-5 text-red-500" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M12.24 10.285V14.4h6.806c-.275 1.765-2.056 5.174-6.806 5.174-4.095 0-7.439-3.389-7.439-7.574s3.345-7.574 7.439-7.574c2.33 0 3.891.989 4.785 1.849l3.254-3.138C18.189 1.186 15.479 0 12.24 0c-6.635 0-12 5.365-12 12c6.926 0 11.52-4.869 11.52-11.726 0-.788-.085-1.39-.189-1.989H12.24z"/>
                        </svg>
