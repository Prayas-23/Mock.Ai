...
import { NavbarDemo } from './components/AINavbar';
import Footer from './components/AIFooter';
...
import InterviewForm from './interview/CareerInterviewForm';
import useConversation from './stateManage/useConversation';
import { Navigate } from 'react-router-dom';
import QuizPage from './quiz/CareerQuizPage';
import QuizStart from './quiz/CareerQuizStart';
import ResumeLandingPage from './resumeBuilder/CareerResumeLanding';
import ResumeForm from './resumeBuilder/CareerResumeForm';
import useResumeStore from './stateManage/useResumeStore';
import SelectResume from './resumeBuilder/CareerResumeSelector';
import { ResumesProvider } from './context/getAllResume';
import InterviewFeedback from './components/interviewFeedback';
import { MockInterviewLandingPage } from './interview/CareerInterviewLanding';
import Lottie from 'lottie-react';
import pageNotFound from './assets/animations/errorAnimation.json'
import ProfileInterviewForm from './interview/ProfileCareerForm';
import History from './history/History.jsx';
import InterviewPage from './interview/CareerInterviewPage';
